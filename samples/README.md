...
One comprehensive document per qmd-fast HTML format, each **standalone-previewable**,
...
| # | Format | Path | Preview |
|---|--------|------|---------|
| 1 | Marketing website (multi-page) | `site/` | `qmd-fast preview site` |
| 2 | User reference (book) | `docs/guide/` | `qmd-fast preview docs/guide` |
| 3 | Developer reference (book) | `docs/internals/` | `qmd-fast preview docs/internals` |
