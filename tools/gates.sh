...
# `deck_browser` / `reactive_browser` declare it in `required-features` — so without
# this flag cargo would quietly skip building them and the chrome canary below would
