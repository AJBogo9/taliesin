...
| `reader/` | Reader experience | read-only reader enhancers: display prefs (theme/sepia/size/width/spacing), reading position + resume, hover cross-ref cards, anchor copy-links, and a read-state right-rail TOC | (purpose-built) |
