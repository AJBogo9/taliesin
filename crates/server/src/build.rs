...
fn build_page_executing(
    ...
    Ok(rt.block_on(async {
        ...
        // Then what running the cells and finishing the page found, execution's own findings
        // at their cells among it.
        pass.diags.iter().skip(printed).for_each(log_diag);
