...
pub use render::{
    ...
    deck_client_script, escape_attr, favicon_link, has_mermaid, html_escape, js_cell_libs_js,
    katex_css_bytes, mermaid_bundle_js, render_doc_to_page, render_document,
