...
pub use render::{
    ...
    deck_client_script, escape_attr, favicon_link, has_mermaid, html_escape,
    html_page_from_doc_in_site_external, js_cell_libs_js, katex_css_bytes, mermaid_bundle_js,
