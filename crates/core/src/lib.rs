...
pub use render::{
    ...
    ScriptSummary, TOC_SPY_JS, assemble_deck_page, assemble_html_page, attach_pyodide_index,
    classify_exec_output, code_scripts, core_enhance_js, deck_client_script, deck_overlay_html,
    deck_shared_css, deck_shared_css_linked_fonts, deck_shared_js, deck_slide_blocks,
    degrade_pyodide_cells, escape_attr, favicon_link, has_mermaid, html_escape,
