...
pub use render::{
    ...
    render_doc_to_page_external, render_doc_to_page_mermaid_file, render_document,
    render_document_scoped_with_site, render_document_with_includes,
    render_document_with_includes_scoped, render_html_page, render_html_page_with_includes,
    render_single_doc, shared_site_css, shared_site_css_linked_fonts, title_with_site_suffix,
};
