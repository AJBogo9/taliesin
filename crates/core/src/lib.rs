...
pub use render::{
    ...
    code_scripts, escape_attr, favicon_link, has_ojs, html_escape, html_page_from_doc_in_site,
    ojs_head, ojs_init, render_doc_to_page, render_document, render_document_with_includes,
