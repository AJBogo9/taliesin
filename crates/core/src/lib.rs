...
pub use render::{
    ...
    core_enhance_js, escape_attr, favicon_link, has_mermaid, html_escape, js_cell_libs_js,
    katex_css_linked_fonts, mermaid_bundle_js, mermaid_min_js, render_doc_to_page, render_document,
    render_document_scoped_with_site, render_single_doc, shared_site_css,
