...
pub use render::{
    Block, DeckParts, DocFormat, OutputMode, PageParts, RenderedDoc, SEARCH_JS, TOC_SPY_JS,
    assemble_deck_page, assemble_html_page, code_scripts, core_enhance_js, deck_client_script,
    escape_attr, favicon_link, has_mermaid, html_escape, js_cell_libs_js, katex_css_bytes,
    mermaid_bundle_js, render_doc_to_page, render_document, render_document_with_includes,
