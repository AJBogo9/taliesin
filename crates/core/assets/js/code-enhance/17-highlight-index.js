// My highlights: an index + Markdown export over the reader's highlights (taliInitHighlights).
...
function taliInitHighlightIndex() {
  ...
  function render() {
    ...
    load().forEach(function (h) {
      ...
      go.addEventListener('click', function () {
        ...
        if (b) { window.taliReaderMenu.close(); b.scrollIntoView({ block: 'center', behavior: 'smooth' }); flash(b); }
      });
    ...
    exp.addEventListener('click', function () {
      ...
      // Best-effort clipboard; the visible textarea is the reliable path. (Not taliCopyText: its
  ...
  var section = window.taliReaderMenu.addSection('Highlights', body, render);
  function refresh() {
